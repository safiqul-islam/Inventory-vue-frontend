            ...
            <div id="mainsidebar">
              <ul class="sidebar-menu custom-scrollbar">
                <li class="sidebar-item">
                  <RouterLink :to="{name:'Dashboard'}"  class="sidebar-link only-link">
                ...
                <li class="sidebar-item">
                  ...
                  <ul class="nav-submenu menu-content">
                    <li>
                      <RouterLink :to="{ name: 'addProperty'}" >
                  ...
                  <ul class="nav-submenu menu-content">
                    ...
                    <li>
                      <a href="add-user-wizard.html">
                        <i data-feather="chevrons-right"></i>
                        Add user wizard
                        <span class="label label-shadow ms-1">new</span>
                      </a>
                    </li>
                    <li>
                ...
                <li>
                  <div class="upgrade-box">
                    ...
                    >
                      <spane class="d-block"
                        >Raise ticket at "support@pixelstrap.com"</spane
                      >
                    </a>
                    <button
                      type="button"
